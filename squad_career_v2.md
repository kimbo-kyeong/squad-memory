...
- **[2026-07-08 신규] 유형그룹별 버전 2종** (4챕터 대상 6트랙을 2D/5D 그룹 + 나머지로 분리, 유형별 차등 윈도우):
  ...
  - `커리어_취업솔루션_코호트정착_목표추적.sql` = **[목표 추적, 3층]** 유형그룹 × 과목 × 수료주로 ①초기진입%[수료7일전~14일후] ②정착 W+1~4(각 주+평균) ③지속 W+5~8평균 을 한 뷰에서 봄 + 관측주차/관측상태 + 초기진입 목표선(잠정 2D83/5D80). 모수=대상6과정 수료실업자(방문필터無). 대상 미래수료라 현재 0행(초기진입=수료2주후·정착=4주후·지속=8주후 확정). **목표 정의·베이스라인·QA/PM 레버 상세는 [[squad_career_employment]] ⑤ (2026-07-09).**
