...
description: 학습관리 스쿼드 지표한판 + A.tani 사용패턴 분석 - chathistory.timestamp 기반, 평일만 집계, 챕터 KPI 13% 권장 (2026-04-21 최종)
type: project
originSessionId: bf0b0828-ed19-48fe-982a-28f40756bf13
---
# 학습관리 스쿼드 A.tani (구현 + 분석 완료)
...
- **학관스 활동일 정의 두 가지 공존 (2026-06-08 발견)**:
